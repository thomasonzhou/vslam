...
namespace {
    ...
    class EdgePointTranslation: public g2o::BaseUnaryEdge<kTranslationDim, Eigen::Vector3d, VertexPose> {
    public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
    
    EdgePointTranslation(const Eigen::Vector3d& translation) : translation_(translation) {};
    ...
    typedef g2o::BlockSolver<g2o::BlockSolverTraits<kPoseDim, kTranslationDim>> BlockSolverType;
...
namespace estimation::icp {
    void NonlinearICPSolver::solve(
        ...
        for (size_t i = 0; i < std::min(points3d_cam1.size(), points3d_cam2.size()); ++i) {
