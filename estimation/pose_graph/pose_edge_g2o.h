...
[[nodiscard]] Eigen::Matrix<double, 6, 6> inv_right_jacobian_approx_se3(const Sophus::SE3d& error){
...
class EdgePoseOdom: public g2o::BaseBinaryEdge<6, Sophus::SE3d, VertexPose, VertexPose>{
public:
EIGEN_MAKE_ALIGNED_OPERATOR_NEW

void computeError() override{
    const Sophus::SE3d v1 = (static_cast<const VertexPose*>(_vertices[0]))->estimate();
    const Sophus::SE3d v2 = (static_cast<const VertexPose*>(_vertices[1]))->estimate();
...
void linearizeOplus() override{
    ...
    Eigen::Matrix<double, 6, 6> J_r_inv = inv_right_jacobian_approx_se3(Sophus::SE3d::exp(_error));
