...
class EdgeProjection
    : public g2o::BaseUnaryEdge<kPixelDims, Eigen::Vector2d, VertexPose> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
  ...
  void linearizeOplus() override {
    ...
    _jacobianOplusXi << -fx / Z, 0.0, fx * X / (Z * Z), fx * X * Y / (Z * Z),
        -fx - fx * (X * X) / (Z * Z), fx * Y / Z, 0.0, -fy / Z,
...
typedef g2o::BlockSolver<g2o::BlockSolverTraits<kPoseDim, kLandmarkDim>>
    BlockSolverType;
