...
public:
    ...
    ): img1_(img1), img2_(img2), depths1_(depths1), 
...
private:
    ...
    bool cam2_from_cam1(const size_t i, const cv::Point2d& p1, const Eigen::Matrix3d &K1_inv, geometry::PointPixel &point2_data, const Sophus::SE3d &T_12){
        return geometry::cam2_from_cam1(depths1_[i], p1, K1_inv, intrinsics2_, img2_.size(), point2_data, T_12, kHalfPatch);
    };
...
void project_points(const std::vector<double>& depths1,
    ...
    const Sophus::SE3d &T_12){
        ...
        for (size_t i = 0; i < p1.size(); ++i){
            ...
            if(geometry::cam2_from_cam1(depths1[i], p1[i], K1_inv, intrinsics2, img2_size, data_cam2, T_12, kHalfPatch)){
